...
public class ArticlePageObject extends MainPageObject {
    ...
    private static final String
            ...
            FOOTER_ELEMENT = "//*[@resource-id='org.wikipedia:id/page_external_link']//*[@text='View page in browser1']",
    ...
    public void clickOnFolderName(String folder_name) {
        String findClickOnCreatedFolderImMyLists = "//android.widget.TextView[@text='" + folder_name + "']";
        this.waitForElementAndClick(
                By.xpath(findClickOnCreatedFolderImMyLists),
